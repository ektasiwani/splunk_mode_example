...
$sql = mysqli_query($con,"INSERT INTO ccse_questions (question,type,q_number) VALUES ('".$question."','".$type."','".$numb."')") or die (mysqli_error());
$lastId = mysqli_insert_id($con);
mysqli_query($con,"UPDATE ccse_questions SET question_id='$lastId' WHERE id='$lastId' LIMIT 1") or die (mysqli_error());
if($type == 'tf'){
if($isCorrect == "answer1"){
$sql2 = mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer1','1')");
mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer2','0')") or die(mysqli_error());
$msg='Thanks,your question has been added';
header('location:addQuestions_ccse.php?msg='.$msg.'');
exit();
}
if($isCorrect == "answer2"){
$sql2 = mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer2','1')");
mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer1','0')") or die(mysqli_error());
$msg='Thanks,your question has been added';
header('location:addQuestions_ccse.php?msg='.$msg.'');
exit();}
}
...
$sql2= mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer1','1')");
mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer2','0')") or die(mysqli_error());
mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer3','0')") or die(mysqli_error());
mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer4','0')") or die(mysqli_error());
$msg = 'Thanks,your question has been added';
header('location:addQuestions_ccse.php?msg='.$msg.'');
exit();}
if($isCorrect == "answer2"){
...
$sql2= mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer3','1')");
mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer1','0')") or die(mysqli_error());
mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer2','0')") or die(mysqli_error());
mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer4','0')") or die(mysqli_error());
$msg = 'Thanks,your question has been added';
...
$sql2= mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer4','1')");
mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer1','0')") or die(mysqli_error());
mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer2','0')") or die(mysqli_error());
mysqli_query($con,"INSERT INTO ccse_answers (question_id,answer,correct) VALUES ('$lastId','$answer3','0')") or die(mysqli_error());
$msg = 'Thanks,your question has been added';
...
require_once("conect.php");
mysqli_query($con,"TRUNCATE TABLE ccse_questions") or die(mysqli_error());
mysqli_query($con,"TRUNCATE TABLE ccse_answers") or die(mysqli_error());
//check if delete or not.
$sql1= mysqli_query($con,"SELECT id FROM ccse_questions LIMIT 1") or die(mysqli_error());
$sql2= mysqli_query($con,"SELECT id FROM ccse_answers LIMIT 1") or die(mysqli_error());
...
<h2 style="font-size: 30px; font-style:tahoma;">What type of quiz you want to create?</h2><br>
<button onClick="showDiv('tf','mc')">True/False</button>&nbsp;&nbsp;<button onClick="showDiv('mc','tf')">Multiple choice</button>&nbsp;&nbsp;
<br><br><form  style="font-size: 20px; font-style:tahoma;" action="addQuestions_ccse.php"  method="post">
...
<form  style="font-size: 20px; font-style:tahoma;" action="addQuestions_ccse.php" name="addQuestion" method="post">
...
<form style="font-size: 20px; font-style:tahoma;" action="addQuestions_ccse.php" name="addMcQuestion" method="post">
<strong>Question Number</strong>
<br><br>
