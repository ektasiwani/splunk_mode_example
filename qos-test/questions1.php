...
$answers= "";
$q="";
$sql=mysqli_query($con,"SELECT id FROM ccsa_questions");
...
if(!isset($_SESSION['answer_array']) || $_SESSION['answer_array']< 1){
 ...
 $arrCount = count($_SESSION['answer_array']);
  ...
  <form action="userAnswers1.php" method="post">
  ...
  $singleSQL= mysqli_query($con,"SELECT * FROM ccsa_questions WHERE id='".$question."' LIMIT 1");
  ...
  $sql2 = mysqli_query($con,"SELECT * FROM ccsa_answers WHERE question_id='".$question."' ORDER BY rand()");
