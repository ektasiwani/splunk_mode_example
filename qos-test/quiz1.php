...
document.getElementById('btnSpan').innerHTML += '<a href="ccna.php">Click here</a>';
}
secs--;
...
function getQuestion(){
 ...
 var nums = hr.responseText.split(",");
	 ...
	 hr.open("GET","questions1.php?question=" + <?php echo $question; ?>, true);
	 hr.send();
	 }
	 function x() {
	 ...
	 var url = 'quiz1.php?question=<?php echo $next; ?>';
	 window.location=url;
	 }
	 }
	 p.send(vars);
