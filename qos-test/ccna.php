...
$msg= addslashes($msg);
 ...
 $singleSQL= mysqli_query($con,"SELECT max(q_number) FROM ccsa_questions");
...
function startQuiz(url){
 ...
 <body>
  <div style="font-family: Monda,tahoma; font-size:30px; color:#4c7529; width: 500px; margin-left:120px;">
 ...
 <center><button style="margin-left:25px; width:100; height:40px; color:white; background-color:green;"  onClick="startQuiz('quiz1.php?question=1')"><b>Attempt</b></button></center>
