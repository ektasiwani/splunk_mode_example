...
session_destroy();
header("location: ccse.php?msg=$msg");
exit();
}
...
document.getElementById('btnSpan').innerHTML += '<a href="ccse.php">Click here</a>';
}
secs--;
...
function getQuestion(){
 ...
 var nums = hr.responseText.split(",");
	 ...
	 hr.open("GET","questions2.php?question=" + <?php echo $question; ?>, true);
	 hr.send();
	 }
	 function x() {
