...
$msg= addslashes($msg);
 ...
 $singleSQL= mysqli_query($con,"SELECT max(q_number) FROM ccse_questions");
...
function startQuiz(url){
 ...
 <center><button style="margin-left:25px; width:100; height:40px; color:white; background-color:green;"  onClick="startQuiz('quiz2.php?question=1')"><b>Attempt</b></button></center>
