...
CREATE TABLE questions (
  q_number INT(50) NOT NULL,id INT(30) NOT NULL AUTO_INCREMENT,question_id INT(20) NOT NULL,question VARCHAR(250) NOT NULL,
...
CREATE TABLE ccsa_answers (
  id INT(30) NOT NULL AUTO_INCREMENT, question_id INT(20) NOT NULL,answer VARCHAR(250) NOT NULL,
  correct ENUM('0','1') NOT NULL,
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
CREATE TABLE ccsa_questions (
  q_number INT(50) NOT NULL,id INT(30) NOT NULL AUTO_INCREMENT,question_id INT(20) NOT NULL,question VARCHAR(250) NOT NULL,
  type VARCHAR(50) NOT NULL, UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
CREATE TABLE ccse_answers (
  id INT(30) NOT NULL AUTO_INCREMENT, question_id INT(20) NOT NULL,answer VARCHAR(250) NOT NULL,
  correct ENUM('0','1') NOT NULL,
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
CREATE TABLE ccse_questions (
  q_number INT(50) NOT NULL,id INT(30) NOT NULL AUTO_INCREMENT,question_id INT(20) NOT NULL,question VARCHAR(250) NOT NULL,
  type VARCHAR(50) NOT NULL, UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
