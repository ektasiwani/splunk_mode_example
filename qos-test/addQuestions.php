...
$sql = mysqli_query($con,("INSERT INTO questions (question,type,q_number) VALUES ('".$question."','".$type."','".$numb."')"))or die (mysql_error());
$lastId = mysqli_insert_id($con);
mysqli_query($con,("UPDATE questions SET question_id='$lastId' WHERE id='$lastId' LIMIT 1")) or die (mysql_error());

if($type == 'tf'){
if($isCorrect == "answer1"){
$sql2 = mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer1','1')"));
mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer2','0')")) or die(mysql_error());
$msg='Thanks,your question has been added';
header('location:addQuestions.php?msg='.$msg.'');
exit();
}
if($isCorrect == "answer2"){
$sql2 = mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer2','1')"));
mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer1','0')")) or die(mysql_error());
$msg='Thanks,your question has been added';
header('location:addQuestions.php?msg='.$msg.'');
exit();}
}
...
$sql2= mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer1','1')"));
mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer2','0')")) or die(mysql_error());
mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer3','0')")) or die(mysql_error());
mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer4','0')")) or die(mysql_error());
$msg = 'Thanks,your question has been added';
header('location:addQuestions.php?msg='.$msg.'');
exit();}
if($isCorrect == "answer2"){
...
$sql2= mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer3','1')"));
mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer1','0')")) or die(mysql_error());
mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer2','0')")) or die(mysql_error());
mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer4','0')")) or die(mysql_error());
$msg = 'Thanks,your question has been added';
...
$sql2= mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer4','1')"));
mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer1','0')")) or die(mysql_error());
mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer2','0')")) or die(mysql_error());
mysqli_query($con,("INSERT INTO answers (question_id,answer,correct) VALUES ('$lastId','$answer3','0')")) or die(mysql_error());
$msg = 'Thanks,your question has been added';
...
$sql1= mysqli_query($con,("SELECT id FROM questions LIMIT 1")) or die(mysqli_error());
$sql2= mysqli_query($con,("SELECT id FROM answers LIMIT 1")) or die(mysqli_error());
...
<form style="font-size: 20px; font-style:tahoma;" action="addQuestions.php" name="addQuestion" method="post">
...
<form style="font-size: 20px; font-style:tahoma;" action="addQuestions.php" name="addMcQuestion" method="post">
<strong>Question Number</strong>
<br><br>
