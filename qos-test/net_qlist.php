...
require_once("conect.php");
  ...
  //query for question
  $singleSQL= mysqli_query($con,"SELECT * FROM questions WHERE type='mc'");
  ...
  //for answers query
  $sql2 = mysqli_query($con,"SELECT answer FROM answers WHERE question_id='".$question_id."' AND correct = '1'");
