...
require_once("conect.php");
  ...
  //query for question
  $singleSQL= mysqli_query($con,"SELECT * FROM ccsa_questions WHERE type = 'mc' ");
  ...
  //for answers query
  $sql2 = mysqli_query($con,"SELECT answer FROM ccsa_answers WHERE question_id='".$question_id."' AND correct = '1'");
